const kidsinterface = {}
kidsinterface.kidspageHandler = function(){
    ...
    function topsHandler(){
         view.showComponents(paths.kidstopspage);
        // view.showfield('Men');
    ...
    function jeansHandler(){
         view.showComponents(paths.kidsjeanspage);
        // view.showfield('Men');
        // view.showComponents('topspage')
    }
    ...
    function jacketHandler(){
         view.showComponents(paths.kidsjacketpage);
        // view.showfield('Men');
        // view.showComponents('topspage')
    }
    ...
    function shoesHandler(){
         view.showComponents(paths.kidsshoespage);
        // view.showfield('Men');
        // view.showComponents('topspage')
    }
}